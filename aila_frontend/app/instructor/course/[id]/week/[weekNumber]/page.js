      ...
      <div className="flex-1 overflow-hidden flex flex-col">
        <div className="flex-1 overflow-y-auto pb-10">
          <div className="max-w-5xl mx-auto px-8 py-8 space-y-8">
            ...
            {/* Header */}
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Week {weekNumber} — Lecture Dashboard</h1>
            ...
            <div className="bg-white rounded-2xl shadow-md border border-gray-200 p-6">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">PDF or PPTX • This powers your concept map & quizzes</p>
                </div>
                <UploadLectureForm
                  courseId={courseId}
            ...
            <UploadedFilesList courseId={courseId} week={weekNumber} onReload={fetchKnowledgeGraph} />
            ...
            {processingFiles.length > 0 && (
              <div className="bg-blue-50 border border-blue-200 rounded-xl p-5">
                ...
                {processingFiles.map(({ processingId, fileName }) => (
                  <ProcessingFileStatus key={processingId} processingId={processingId} fileName={fileName} />
                ))}
              </div>
            )}

            {/* CONCEPT MAP - SAFE & BEAUTIFUL */}
                  ...
                  {quizzes.map(q => (
                    ...
                    >
                      ...
                      <div className="text-sm text-gray-600 mt-1">
                        Concepts: {
                          q.concept_ids
                            .map(cid => knowledgeGraph.nodes.find(n => n.id === cid)?.label || cid)
                            .join(', ')
                        }
                      </div>
                    </button>
